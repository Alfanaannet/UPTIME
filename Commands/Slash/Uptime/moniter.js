    ...
    try {
      ...
      if (sub === "total") {
        ...
        if (url) {
          ...
          urlsConfig.find({ userID: interaction.member.user.id }, async function(err, data) {
